         ...
         <div class="center">
             ...
             <div class="nav">
               <!-- Menu -->
						...
						<li><div style="background-color: #6F5499; color: white">单题录入</div>
						     <ul>
								<li><div style="background-color: #6F5499; color: white">第一章</div>
								    <ul>
										<li><div style="background-color: #6F5499; color: white" onclick="window.location.href='jsp/teacher/singleChoice.jsp?section=1'">单选题</div></li>
										<li><div style="background-color: #6F5499; color: white" onclick="window.location.href='jsp/teacher/blankFilling.jsp?section=1'">填空题</div></li>
									</ul>
								</li>
			    ...
			    <form action="inputDatabase.action" method="post">
			     <div class="scan_table">
			         
			             <div class="question">题<span style="visibility:hidden">A</span>目：<input type="text" name="question"/><input type="text" value="<%=request.getParameter("section")%>" name="section" id="c100" style="visibility:hidden"/>
			             </div>
			             <div class="question">答<span style="visibility:hidden">A</span>案：<input type="text" name="result"/>
			             </div>
			             <div class="question">选项A：<input type="text" name="answerA"/>
			             </div>
			             <div class="question">选项B：<input type="text" name="answerB"/>
			             </div>
			             <div class="question">选项C：<input type="text" name="answerC"/>
			             </div>
			             <div class="question">选项D：<input type="text" name="answerD"/>
			             </div>
			      </div>
			         <div class="bn">
			             <input type="submit" value="提交添加" id="if"/>
			         </div>
                   </form>
             </div>
