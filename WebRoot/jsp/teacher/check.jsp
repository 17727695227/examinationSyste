             ...
             <div class="scan_center">
               ...
               <!-- Menu -->
					...
					<ul style="width:100px;" id="menu">
						<li><div>按班查询</div>
						    <ul>
								<li><div><a href="class_check.action?clas=1" style="text-decoration: none">1班</a></div></li>
								<li><div><a href="class_check.action?clas=2" style="text-decoration: none">2班</a></div></li>
							</ul>
						</li>
						...
						<li><div onclick="a2();">排序查询</div>
						    <ul>
								<li><div><a href="totalScore.action?clas=1" style="text-decoration: none">1班</a></div></li>
								<li><div><a href="totalScore.action?clas=2" style="text-decoration: none">2班</a></div></li>
							</ul>
						</li>
						<li><div>导出excel</div>
						    <ul>
						        <li><div><a href="OutputExcel.action?clas=1" style="text-decoration: none">1班</a></div></li>
						        <li><div><a href="OutputExcel.action?clas=2" style="text-decoration: none">2班</a></div></li>
						    </ul>
						</li>
					</ul>
             </div>
         </form action="class_check.action" method="post"> 
              <div class="check_right">
                     <table border="1px" cellspacing="0px" style="border-collapse:collapse" class="ttaabb">
                         <tr><td>学号</td><td>班级</td><td>章节</td><td>是否考试</td><td>选择题分数</td><td>填空题分数</td><td>开始时间</td><td>结束时间</td><td>总共用时</td><td>做对数量</td><td>总分</td></tr>
                       
                       <s:iterator value="#request.class_check" id="check">
                       <tr>
