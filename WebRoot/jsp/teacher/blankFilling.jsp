         ...
         <div class="center">
             ...
             <div class="nav">
               <!-- Menu -->
			    ...
			    <form action="inputBlank.action" method="post">
			     <div class="scan_table">
			         
			             <div class="question">题<span style="visibility:hidden">A</span>目：<input type="text" name="question"/>
			             <input type="text" value="<%=request.getParameter("section")%>" name="section" id="c100" style="visibility:hidden"/>
			             </div>
